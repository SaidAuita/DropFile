...
if [ -z "$PYTHON_BIN" ]; then
    ...
    echo ""
    echo "Чтобы быстро установить Python 3, выполните в Терминале:"
    echo "1) Официальный пакет в 1 команду (рекомендуется):"
    ...
    echo ""
    echo "2) Через инструменты разработчика Apple:"
    echo "   xcode-select --install"
    echo ""
    echo "3) Или через Homebrew:"
